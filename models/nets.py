...
class GeneratorUNetV1(nn.Module):
    def __init__(self, norm_layer='instance'):
        ...
        self.inc2 = DoubleConvBlock(32, 64, normalize=norm_layer, bias=True, dropout=0)
        self.d1 = DownBlock(64, 128, normalize=norm_layer, bias=True, dropout=0)
        self.d2 = DownBlock(128, 256, normalize=norm_layer, bias=True, dropout=0)
        self.d3 = DownBlock(256, 512, normalize=norm_layer, bias=True, dropout=0)
        self.d4 = DownBlock(512, 1024, normalize=norm_layer, bias=True, dropout=0)

        # TODO: Try intermidiate steps
        
        self.u1 = UpBlock(1024, 512, normalize=norm_layer, bias=True, dropout=0)
        self.u2 = UpBlock(512, 256, normalize=norm_layer, bias=True, dropout=0)
        self.u3 = UpBlock(256, 128, normalize=norm_layer, bias=True, dropout=0)
        self.u4 = UpBlock(128, 64, normalize=norm_layer, bias=True, dropout=0)
        self.outc = OutConvBLock(64, 48)
